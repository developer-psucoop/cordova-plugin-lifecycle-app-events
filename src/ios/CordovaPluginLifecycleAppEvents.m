...
#import "CordovaPluginLifecycleAppEvents.h"

@implementation CordovaPluginLifecycleAppEvents

- (void)pluginInitialize {
    NSLog(@"[CordovaPluginLifecycleAppEvents] Plugin is registered.");
}
...
- (void)onAppTerminate {
	...
	NSLog(@"[CordovaPluginLifecycleAppEvents] App is terminating.");
}
